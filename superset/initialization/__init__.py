...
class SupersetAppInitializer:  # pylint: disable=too-many-public-methods
    ...
    def check_async_queries_secret(self) -> None:
        """Warn when the async-queries JWT secret is left at its default value."""
        if (
        ...
        self._log_config_warning(
            ...
            "GLOBAL_ASYNC_QUERIES_JWT_SECRET has not been changed from "
            "its default value.\n"
            "The default value is publicly known and must be replaced "
    ...
    def init_app(self) -> None:
        ...
        self.check_async_queries_secret()
